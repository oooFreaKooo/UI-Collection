...
const componentOptions = [
    'AnimatedSizes', 'RealisticToggle', 'StarRatingAnimation', 'MorphingPagination', 'IsometricLayerHover', 'AnimatedToggle', '3DToggle', 'MobileMenuToggle', 'AnimatedLikeButton', 'AnimatedCheckbox',
]
