...
const componentOptions = [
    'AnimatedSizes', 'RealisticToggle', 'PaperPlaneSend', 'StarRatingAnimation', 'MorphingPagination', 'IsometricLayerHover', 'AnimatedToggle', '3DToggle', 'MobileMenuToggle', 'AnimatedLikeButton', 'AnimatedCheckbox',
]
